<h1 align="center">Japanese Dessert Shop</h1>
...
- **Factory Method Pattern**: For creating different types of dessert products.
- **Command Pattern**: For encapsulating order requests as objects.
- **Singleton Pattern**: Ensures a single instance of critical components like the order system.

---

## UML Diagrams

The project includes UML diagrams created in Draw.io to provide a visual representation of the system's architecture:
- **Class Diagram**: Outlines the structure of classes and their relationships.
- **Sequence Diagram**: Details the interaction flow for adding products to the system.

For a detailed view, refer to the accompanying PDF document (`Report.pdf`).
